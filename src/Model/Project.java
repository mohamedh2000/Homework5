...
/**
 * Represents a new Project that will hold all of the layers. This will be used as a shell to keep all of the
 * information of each layer together, making it easier to retrieve and save the current state of the layers.
 */
public class Project {
    ...
    /**
     * This will save the topmost layer in the project. It needs to know the file type for the export.
     * @param filetype A string representing the type of file that we want to export: ppm, jpeg or png.
    ...
    /**
     * Exports all of the layers and creates a text file with: the project name,
     * the name of the layer, the visibility, if its the current layer, and the file path
     * it was written to during the export.
    ...
    /**
     * This takes in a name, whether its visible or not, whether its the current layer or not,
     * the file path and file type. It will load the data from the filePath, pass the new parameters into the layer
     * generated and then add that to the current stack of layers.
