...
/**
 * This holds the export class. In the case that we need another type of class instead of just a
 * layer, we can easily extend these methods and both a layer and the new class can export the ppm
 * jpeg or png formats.
 */
public abstract class Export {
  ...
  /**
   * An abstracted function that handles taking the colors of each pixel and returning the
   * binary/hex rgb int.
   *
   ...
   */
  public BufferedImage writeBufferedImage(int width, int height,
      HashMap<Integer, ArrayList<Pixel>> pixelToRow) {
