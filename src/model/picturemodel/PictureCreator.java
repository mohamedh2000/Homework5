...
public class PictureCreator {
  ...
  /**
   * Returns a new picture with a checkerboard pattern, alternating colors each pixel. The tileSize
   * should handle the number of tiles as well.
   *
   * @param color1   The first color in the pattern.
   * @param color2   The second color in the pattern.
   * @param width    The width of the picture in pixels.
   * @param height   The height of the picture in pixels.
   * @param tileSize The size of a tile. The tile Size will be applied to height and width of a
   *                 tile.
