...
public class LayerTest {
   ...
   * @throws IOException Tests if you can read a jpeg/png file
   */
  @Test
  public void testJpegPngRead() throws IOException { //export top most layer
    ...
    Layer aenamiLayerII = new ImageUtil().readPPM("aenami.ppm");
    assertTrue(aenamiLayer.getPixelPositions().equals(aenamiLayerII.getPixelPositions()));
  }

  /**
   * Tests the blend method.
   * @throws IOException Tests if you can blend two files.
   */
  @Test
  public void testBlend() throws IOException {
    ...
    assertTrue(rainbowLayer.getPixelPositions() != koalaScaledLayer.getPixelPositions());
  }
   ...
   * @throws IOException Tests if you can get Pixel Positions from a layer.
   */
  @Test
   ...
   * @throws IOException Tests the load method.
   */
  @Test
   ...
   * @throws IOException Tests the export layer method.
   */
  @Test
   ...
   * @throws IOException Tests the scrapeInfo Method.
   */
  @Test
